"""CLI for the Kuhn poker Deep CFR replay and averaging ablation."""
...
def build_config(args) -> dict:
    ...
    variants = _filter_variants(
        REPLAY_AVERAGING_VARIANTS, parse_variant_ids(args.variant_ids)
    )
    overrides = {
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the Kuhn poker Deep CFR replay and averaging ablation."
    )
